...
int main()
{
    int i,member;
    bank_mgmt ob[10];
    cout<<"how many member are there";
    cin<<n;
    for(i=0;i<n;i++)
    {
    ob[i].get_data();
    }
    cout<<"1. Display all the customers who have ’Saving accounts’ as account type.";
    cout<<"2. Display all the customers who have registered their nominees.";
    cout<<"3. Display all the customers who were issued debit card today.";
